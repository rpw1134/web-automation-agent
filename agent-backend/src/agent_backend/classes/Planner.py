    ...
    async def react_loop(self, user_request: str):
        ...
        while calls < 15:
            ...
            plan: str|None = (await self.client.chat.completions.create(
                model="gpt-4o-mini",
                messages=[*context, {"role": "assistant", "content": "I must remember to respond using the delimiter-based format with proper sections:+#/OBSERVATION/#\n <your observation of the user request>\n\n#/PLAN/#\n<your thought process on how to achieve the request>\n\n#/FUNCTION_CALLS/#\nfunction_name(arg1=value1,arg2=value2,...)\nanother_function(arg1=value1,...)\n#/DONE/#\nfalse\n\nI must remember that Page_id and locator_uuid is generated by functions I call and may only be passed into functions once provided to me. I can't make them up. I can only use locator functions once I have been given proper UUIDs by get_locator_uuids_by"\
                }],
                max_tokens=1000,
                temperature=0.7
